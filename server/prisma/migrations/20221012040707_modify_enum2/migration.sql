/*
  ...
  - The values [HandlingFee] on the enum `transactionSetting_key` will be removed. If these variants are still used in the database, this will fail.
...
-- AlterTable
ALTER TABLE `transactionSetting` MODIFY `key` ENUM('FirstReward', 'AccumulatedReward', 'AtmHandlingFee', 'BarCodeHandlingFee', 'ServiceFee') NOT NULL;
